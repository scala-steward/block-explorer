...
object TransactionParsers {
  ...
  val parseAddressTransactionDetails = (parseAddress ~ parseTransactionId ~ parseSent ~ parseReceived).map {
    case address ~ txid ~ sent ~ received => AddressTransactionDetails(
